...
Loophole is a fork of Void, which is based on VS Code.

## License

Loophole is licensed under the GNU Affero General Public License Version 3.0 (AGPL-3.0). See the LICENSE.txt file for the full license text.
