	...
	return (
		...
		>
			...
			{showSelections && selections && setSelections && (
				<div className='flex items-center pt-1 pl-1' style={{ gap: '5px' }}>
					{/* + Add file button */}
					<button
						type="button"
						className="text-loophole-fg-3 hover:text-loophole-fg-1 w-5 h-5 rounded flex-shrink-0 flex items-center justify-center cursor-pointer transition-colors bg-[#1e1e1e] border border-white/10 hover:border-white/20"
