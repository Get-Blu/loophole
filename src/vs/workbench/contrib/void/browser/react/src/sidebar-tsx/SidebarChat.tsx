	...
	return (
		<div
			...
			className={`
				...
				border border-[var(--vscode-sideBar-border,rgba(255,255,255,0.06))]
		...
		>
			...
			{showSelections && selections && setSelections && (
				<div className='flex items-center pt-1 pl-1' style={{ gap: '7px' }}>
					{/* + Add file button */}
					<button
						type="button"
						className="text-loophole-fg-3 hover:text-loophole-fg-1 w-5 h-5 rounded flex-shrink-0 flex items-center justify-center cursor-pointer transition-colors bg-[var(--vscode-input-background)] border border-[var(--vscode-input-border,rgba(255,255,255,0.1))] hover:border-[var(--vscode-focusBorder,rgba(255,255,255,0.25))]"
					...
					{/* @ Mention text button */}
					<span className="text-xs text-loophole-fg-3 hover:text-loophole-fg-1 cursor-pointer transition-colors select-none">
						@ Mention
					</span>
			...
			{/* Input section */}
			<div className="relative w-full px-1.5 pt-2 pb-0">
				{children}
					...
					>
						...
						<div
							className={`
								...
								text-xs text-nowrap
								rounded
								${isThisSelectionProspective ? 'bg-[var(--vscode-input-background)] text-loophole-fg-3 opacity-80 border border-[var(--vscode-input-border,rgba(255,255,255,0.12))]' : 'bg-[var(--vscode-input-background)] border border-[var(--vscode-input-border,rgba(255,255,255,0.12))] hover:brightness-110 text-loophole-fg-1'}
...
const UserMessageComponent = ({ chatMessage, messageIdx, isCheckpointGhost, currCheckpointIdx, _scrollToBottom }: { chatMessage: ChatMessage & { role: 'user' }, messageIdx: number, currCheckpointIdx: number | undefined, isCheckpointGhost: boolean, _scrollToBottom: (() => void) | null }) => {
	...
	>
		<div
            ...
            ${mode === 'edit' ? ''
					: mode === 'display' ? 'flex flex-col bg-[var(--vscode-input-background)] border border-[var(--vscode-input-border,rgba(255,255,255,0.12))] text-loophole-fg-1 overflow-x-auto cursor-pointer' : ''
				}
        `}
...
export const SidebarChat = () => {
	...
	>
		<LoopholeInputBox2
			enableAtToMention
			className={`min-h-[30px] px-0.5 pt-0.5 pb-0.5 align-top leading-tight bg-[var(--vscode-sideBar-background)] !bg-[var(--vscode-sideBar-background)]`}
